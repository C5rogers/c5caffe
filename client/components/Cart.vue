...
<template>
    <div>
       <button 
       class="relative w-5 h-5 md:w-10 md:h-10 overflow-visible rounded-md transition duration-200" @click="handleClick" >
            <i class="fa-solid fa-cart-plus text-2xl" :class="{'text-secondary':route.name=='cart'}"></i>
            <!-- the counter -->
